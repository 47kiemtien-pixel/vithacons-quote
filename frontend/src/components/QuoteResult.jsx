    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mt-8 border border-gray-100">
            ...
            <div className="p-5 sm:p-8">
                ...
                <div className="mt-6 sm:mt-8 bg-blue-50 text-blue-800 p-4 rounded-xl text-xs sm:text-sm leading-relaxed border border-blue-100 flex flex-col gap-3 sm:gap-4">
                    ...
                    <div className="mt-2 font-bold flex flex-col gap-1.5 pt-3 border-t border-blue-200/50">
                        <p className="text-blue-900 mb-1">Thông tin liên hệ đúng:</p>
                        <p className="flex items-center gap-2">
                            <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                            Hotline/Zalo: <a href="tel:0972524799" className="text-blue-700 hover:text-blue-900 underline transition-colors">097 252 47 99</a>
                        </p>
                        <p className="flex items-center gap-2">
                            <svg className="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10zm4.5 13.5h-9a.5.5 0 01-.5-.5v-6a.5.5 0 01.5-.5h9a.5.5 0 01.5.5v6a.5.5 0 01-.5.5zM12 9a1 1 0 100 2 1 1 0 000-2zm0 4a1 1 0 100 2 1 1 0 000-2z"></path></svg>
                            Facebook: <a href="https://www.facebook.com/VITHACONS" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-blue-900 underline transition-colors">VITHACONS</a>
                        </p>
                    </div>
                </div>
            </div>
